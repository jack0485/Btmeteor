#ifndef BTMETEOR_BTERROR_H
#define BTMETEOR_BTERROR_H

#define FILE_FD_ERR                 -1  // 无效文件描述符
#define FILE_READ_ERR               -2  // 读取文件失败
...
#define READ_SOCKET_ERR             -13 // 读取套接字失败
